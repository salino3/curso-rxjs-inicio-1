...
//* zip() sirve para combinar Observables

/** Ejercicio: https://swapi.co/api/
...
// ** // se está convertiendo un arreglo(array) => en un objeto
...
//
///
getRequest(`${SW_API}${Luke}`).pipe().subscribe(console.log);
